export default  [
    ...
    },
    {
        ...
        desc: 'AI Model to generate Content for Business',
        icon:'https://cdn-icons-png.flaticon.com/128/6062/6062646.png',
        category: 'Content',
       
        slug: 'write-content',
        aiPrompt: 'Depends on user contentDescription write a content for business ',
        form: [
            {
                label: 'Enter description for your content',
                field: 'textarea',
